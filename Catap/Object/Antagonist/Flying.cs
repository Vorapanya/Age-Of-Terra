...
namespace Catap.Object
{
    class Flying : Enemy
    {
        ...
        public Flying(Texture2D texture, World world, int positionx, int positiony, ContentManager _content)
            : base(texture, world)
        {
            _animations = new Dictionary<string, Animation>
                {
                    { "WalkLeft", new Animation(_content.Load<Texture2D>("Walk/5Walk"), 3,0.2f) },
                    //{ "Attack", new Animation(_content.Load<Texture2D>("Atk/5Attack"), 5) }
                };
