...
namespace Catap.Object
{
    class Bossgun : Enemy
    {
        ...
        public Bossgun(Texture2D texture, World world, int positionx, int positiony, ContentManager _content)
            : base(texture, world)
        {
            _animations = new Dictionary<string, Animation>
                {
                    { "WalkLeft", new Animation(_content.Load<Texture2D>("Walk/EleWalk"), 4,0.2f) },
                    { "Attack", new Animation(_content.Load<Texture2D>("Atk/EleAttack"), 6,0.1f) }
                };
