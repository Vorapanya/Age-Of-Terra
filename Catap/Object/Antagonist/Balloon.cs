...
namespace Catap.Object
{
    class Balloon : Enemy
    {
        ...
        public Balloon(Texture2D texture, World world, int positionx, int positiony, ContentManager _content)
            : base(texture, world)
        {
            _animations = new Dictionary<string, Animation>
                {
                    { "WalkLeft", new Animation(_content.Load<Texture2D>("Walk/BalloonFly"), 5,0.2f) },
                    //{ "Attack", new Animation(_content.Load<Texture2D>("Atk/BalloonAttack"), 5) }
                };
        ...
        public override void update(GameTime gameTime)
        {
            ...
            Vector2 v = new Vector2(_enemyBody.Position.X, 4.5f);
