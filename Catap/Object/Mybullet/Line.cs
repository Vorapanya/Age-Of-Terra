...
namespace Catap.Object.Mybullet
{
    class Line : Bullet
    {
        public Line(Texture2D texture, World world, Vector2 position)
        ...
        {
            if ((string)other.Tag == "ground" || (string)other.Tag == "enemy" || (string)other.Tag == "suicide")
            {
                isRemove = true;
