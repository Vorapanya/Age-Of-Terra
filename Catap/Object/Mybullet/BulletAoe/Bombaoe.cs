...
{
    class Bombaoe : Bullet
    {
        public Bombaoe(Texture2D texture, World world, Vector2 position, ContentManager _content)
            : base(texture, world, position)
        {

            _animations = new Dictionary<string, Animation>
                {
                    { "boom", new Animation(_content.Load<Texture2D>("Eff/Explosion1"), 10 ,0.1f) },
                };
