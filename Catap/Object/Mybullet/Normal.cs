...
namespace Catap.Object.Mybullet
{
    class Normal : Bullet
    {
        public Normal(Texture2D texture, World world, Vector2 position)
        ...
        {
            if ((string)other.Tag == "ebullet" || (string)other.Tag == "ebomb" || (string)other.Tag == "efly" || (string)other.Tag == "blank")
            {
                return true;
            }
