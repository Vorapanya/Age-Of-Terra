...
{
    class Victory9 : DrawableGameComponent
    {
        // Sounds
        ...
        public Victory9(Game game, Player play, double _life)
            : base(game)
        {
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/VictoryBackgroundStage3");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _test = new Stage10(_game, _player, _myLife);
