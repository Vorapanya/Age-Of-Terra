...
{
    class Victory6 : DrawableGameComponent
    {
        // Sounds
        ...
        public Victory6(Game game, Player play, double _life)
            : base(game)
        {
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/VictoryBackgroundStage2");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _test = new Stage7(_game, _player, _myLife);
