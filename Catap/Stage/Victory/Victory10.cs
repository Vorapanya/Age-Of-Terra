...
{
    class Victory10 : DrawableGameComponent
    {
        // Sounds
        ...
        public Victory10(Game game, Player play, double _life)
            : base(game)
        {
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/VictoryBackgroundStage4");
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _test = new Stage11(_game, _player, _myLife);
