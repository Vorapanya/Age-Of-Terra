...
{
    public class Stage8 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage8(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            {
                //wave1
                new Flying(_flyTexture, _world, 14, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,16,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,17,0,Game.Content),
                ...
                new Flying(_flyTexture, _world, 22, 4,Game.Content),
                ...
                new Goblin(_goblinText, _world,42,0,Game.Content),
                new Balloon(_balloonTexture, _world, 35, 4,Game.Content),

                //wave4
                new Goblinb(_goblinbTexture, _world,47,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,48,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,49,0,Game.Content),
                new Bossgun(_bossgunTexture, _world,50,0,Game.Content),
                new Flying(_flyTexture, _world, 50, 4,Game.Content),
                new Flying(_flyTexture, _world, 51, 4,Game.Content),
                new Flying(_flyTexture, _world, 52, 4,Game.Content),
                new Flying(_flyTexture, _world, 53, 4,Game.Content),
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory8(_game, _player, _protag[0].life);
