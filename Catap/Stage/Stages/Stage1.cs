...
{
    public class Stage1 : DrawableGameComponent
    {
        // Sounds
       ...
       string Text = "Press A or D to rotate the ball\n" +
        ...
        protected override void LoadContent()
        {
            ...
            _player = new Player(_playerText);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory1(_game,_player,_protag[0].life);
