...
{
    public class Stage11 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage11(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _song = Game.Content.Load<Song>("Sounds/BGM/DestinationEarth");
            ...
            _fortTexture = Game.Content.Load<Texture2D>("Building/FallenAgSta3");
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/Background4");
            _hpTexture = Game.Content.Load<Texture2D>("BG/HP3");
            ...
            _enemy = new List<Enemy>()
            {
                ...
                new Flying(_flyTexture, _world, 16, 4,Game.Content),
                new Flying(_flyTexture, _world, 15, 4,Game.Content),
                new Goblin(_goblinText, _world,20,0,Game.Content),
                new Goblin(_goblinText, _world,21,0,Game.Content),
                new Goblin(_goblinText, _world,22,0,Game.Content),
                new Goblin(_goblinText, _world,23,0,Game.Content),
                new Goblin(_goblinText, _world,24,0,Game.Content),
                new Goblin(_goblinText, _world,25,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,26,0,Game.Content),
                ...
                //wave2
                new Goblinb(_goblinbTexture, _world,35,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,36,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,37,0,Game.Content),
                new Flying(_flyTexture, _world, 37, 4,Game.Content),
                new Flying(_flyTexture, _world, 38, 4,Game.Content),
                new Bossgun(_bossgunTexture, _world,38,0,Game.Content),
                new Balloon(_balloonTexture, _world,35, 4,Game.Content),

                //wave3
                new Balloon(_balloonTexture, _world,45, 4,Game.Content),
                new Balloon(_balloonTexture, _world,48, 4,Game.Content),
                new Bossummon(_bosssumTexture, _world,47,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,53,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,54,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,55,0,Game.Content),

                //wave4
                new Bossgun(_bossgunTexture, _world,70,0,Game.Content),
                new Balloon(_balloonTexture, _world,67, 4,Game.Content),
                new Balloon(_balloonTexture, _world,70, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,71,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,72,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,73,0,Game.Content),
                new Bossummon(_bosssumTexture, _world,74,0,Game.Content),

                //wave5
                new Balloon(_balloonTexture, _world,85, 4,Game.Content),
                new Balloon(_balloonTexture, _world,88, 4,Game.Content),
                new Goblin(_goblinText, _world,95,0,Game.Content),
                new Goblin(_goblinText, _world,96,0,Game.Content),
                new Goblin(_goblinText, _world,97,0,Game.Content),
                new Goblin(_goblinText, _world,98,0,Game.Content),
                new Goblin(_goblinText, _world,99,0,Game.Content),
                new Goblin(_goblinText, _world,100,0,Game.Content),
                new Bossummon(_bosssumTexture, _world,101,0,Game.Content),
                new Flying(_flyTexture, _world, 100, 4,Game.Content),
                new Flying(_flyTexture, _world, 101, 4,Game.Content),
                new Bossgun(_bossgunTexture, _world,105,0,Game.Content),
                new Bossgun(_bossgunTexture, _world,110,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,114,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,115,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,116,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,117,0,Game.Content),
