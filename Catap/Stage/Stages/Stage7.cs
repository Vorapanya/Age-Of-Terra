...
{
    public class Stage7 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage7(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _song = Game.Content.Load<Song>("Sounds/BGM/picoChaseFull");
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/Background3");
            ...
            {
                //wave1
                new Suicide(_suicideTexture, _world, 15, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 16, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 17, 0,Game.Content),
                new Goblin(_goblinText, _world,18,0,Game.Content),
                new Goblin(_goblinText, _world,19,0,Game.Content),
                ...
                new Flying(_flyTexture, _world, 23, 4,Game.Content),
                new Flying(_flyTexture, _world, 24, 4,Game.Content),

                //wave2
                new Balloon(_balloonTexture, _world, 27, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,28,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,29,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,30,0,Game.Content),

                //wave3
                new Goblin(_goblinText, _world,36,0,Game.Content),
                new Goblin(_goblinText, _world,37,0,Game.Content),
                new Goblin(_goblinText, _world,38,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,39,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,40,0,Game.Content),
                new Suicide(_suicideTexture, _world, 41, 0,Game.Content),
                ...
                new Suicide(_suicideTexture, _world, 55, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 56, 0,Game.Content),

                //wave5
                new Flying(_flyTexture, _world, 63, 4,Game.Content),
                new Flying(_flyTexture, _world, 65, 4,Game.Content),
                new Flying(_flyTexture, _world, 67, 4,Game.Content),
                new Goblin(_goblinText, _world,60,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,61,0,Game.Content),
                new Suicide(_suicideTexture, _world, 62, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 63, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 64, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 65, 0,Game.Content),
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory7(_game, _player, _protag[0].life);
