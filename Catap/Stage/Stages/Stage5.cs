...
{
    public class Stage5 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage5(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            {
                //wave1
                new Flying(_flyTexture, _world, 10, 4,Game.Content),
                new Flying(_flyTexture, _world, 11, 4,Game.Content),
                new Flying(_flyTexture, _world, 12, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,14,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,15,0,Game.Content),
                new Suicide(_suicideTexture, _world,16, 0,Game.Content),
                new Suicide(_suicideTexture, _world,17, 0,Game.Content),
                new Suicide(_suicideTexture, _world,18, 0,Game.Content),
                new Suicide(_suicideTexture, _world,19, 0,Game.Content),
                new Suicide(_suicideTexture, _world,20, 0,Game.Content),
                ...
                new Balloon(_balloonTexture, _world, 25, 4,Game.Content),

                //wave2
                new Suicide(_suicideTexture, _world,30, 0,Game.Content),
                new Suicide(_suicideTexture, _world,31, 0,Game.Content),
                new Suicide(_suicideTexture, _world,32, 0,Game.Content),
                new Goblin(_goblinText, _world,33,0,Game.Content),
                new Goblin(_goblinText, _world,34,0,Game.Content),
                new Goblin(_goblinText, _world,35,0,Game.Content),
                new Flying(_flyTexture, _world, 37, 4,Game.Content),
                new Flying(_flyTexture, _world, 38, 4,Game.Content),
                new Flying(_flyTexture, _world, 39, 4,Game.Content),

                //wave3
                new Balloon(_balloonTexture, _world, 40, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,41,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,42,0,Game.Content),
                new Goblin(_goblinText, _world,43,0,Game.Content),
                new Goblin(_goblinText, _world,44,0,Game.Content),
                new Goblin(_goblinText, _world,45,0,Game.Content),
                new Goblin(_goblinText, _world,46,0,Game.Content),
                new Goblin(_goblinText, _world,47,0,Game.Content),
                new Balloon(_balloonTexture, _world, 50, 4,Game.Content),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory5(_game, _player, _protag[0].life);
