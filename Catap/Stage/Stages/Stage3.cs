...
{
    public class Stage3 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage3(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _song = Game.Content.Load<Song>("Sounds/BGM/BlackCauldron");
            ...
            _fortTexture = Game.Content.Load<Texture2D>("Building/FallenAgSta2");
            ...
            _backGround = Game.Content.Load<Texture2D>("BG/Background1");
            _hpTexture = Game.Content.Load<Texture2D>("BG/HP2");
            ...
            _enemy = new List<Enemy>()
            {
                ...
                new Suicide(_suicideTexture, _world, 25, 0,Game.Content),

                //wave2
                new Suicide(_suicideTexture, _world, 35, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 36, 0,Game.Content),
                ...
                new Suicide(_suicideTexture, _world, 47, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 48, 0,Game.Content),
                new Suicide(_suicideTexture, _world, 49, 0,Game.Content),
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory3(_game, _player, _protag[0].life);
