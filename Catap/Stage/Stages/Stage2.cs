...
{
    public class Stage2 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage2(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _enemy = new List<Enemy>()
            {
                ...
                new Goblin(_goblinText, _world,10,0,Game.Content),
                new Goblin(_goblinText, _world,11,0,Game.Content),
                new Goblin(_goblinText, _world,12,0,Game.Content),
                new Goblin(_goblinText, _world,13,0,Game.Content),

                new Flying(_flyTexture, _world, 21, 4,Game.Content),
                ...
                new Flying(_flyTexture, _world, 31, 4,Game.Content),
                new Goblin(_goblinText, _world,30,0,Game.Content),
                new Goblin(_goblinText, _world,31,0,Game.Content),
                new Goblin(_goblinText, _world,32,0,Game.Content),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory2(_game, _player, _protag[0].life);
