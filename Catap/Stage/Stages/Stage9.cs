...
{
    public class Stage9 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage9(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            _enemy = new List<Enemy>()
            {
                ...
                //wave2
                new Bossummon(_bosssumTexture, _world,25,0,Game.Content),

                //wave3
                new Balloon(_balloonTexture, _world, 25, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,26,0,Game.Content),
                new Suicide(_suicideTexture, _world, 27, 0,Game.Content),
                ...
                new Suicide(_suicideTexture, _world, 37, 0,Game.Content),
                new Goblin(_goblinText, _world,38,0,Game.Content),
                new Goblin(_goblinText, _world,39,0,Game.Content),
                new Goblin(_goblinText, _world,40,0,Game.Content),
                new Goblin(_goblinText, _world,41,0,Game.Content),

                //wave5
                new Flying(_flyTexture, _world, 55, 4,Game.Content),
                new Flying(_flyTexture, _world, 56, 4,Game.Content),
                new Flying(_flyTexture, _world, 57, 4,Game.Content),
                new Bossummon(_bosssumTexture, _world,55,0,Game.Content),
                new Bossgun(_bossgunTexture, _world,56,0,Game.Content),
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory9(_game, _player, _protag[0].life);
