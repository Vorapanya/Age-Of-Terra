...
{
    public class Stage6 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage6(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            {
                //wave1
                new Goblinb(_goblinbTexture, _world,18,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,19,0,Game.Content),
                ...
                new Balloon(_balloonTexture, _world, 22, 4,Game.Content),

                //wave2
                new Goblinb(_goblinbTexture, _world,30,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,31,0,Game.Content),
                new Bossgun(_bossgunTexture, _world,32,0,Game.Content),
                ...
                //wave 4
                new Balloon(_balloonTexture, _world, 55, 4,Game.Content),
                new Bossgun(_bossgunTexture, _world,55,0,Game.Content),
                new Balloon(_balloonTexture, _world, 56, 4,Game.Content),
            };
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory6(_game, _player, _protag[0].life);
