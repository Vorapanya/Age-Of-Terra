...
{
    public class Stage10 : DrawableGameComponent
    {
        // Sounds
        ...
        public Stage10(Game game, Player play, double _life) : base(game)
        {
            _game = game;
            _player = play;
            _myLife = _life;
        ...
        protected override void LoadContent()
        {
            ...
            {
                //wave1
                new Flying(_flyTexture, _world, 18, 4,Game.Content),
                new Flying(_flyTexture, _world, 17, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,20,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,21,0,Game.Content),
                ...
                new Goblin(_goblinText, _world,26,0,Game.Content),
                new Goblin(_goblinText, _world,27,0,Game.Content),
                new Flying(_flyTexture, _world, 26, 4,Game.Content),
                new Flying(_flyTexture, _world, 27, 4,Game.Content),

                //wave2
                new Goblinb(_goblinbTexture, _world,30,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,31,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,32,0,Game.Content),
                new Suicide(_suicideTexture, _world,33, 0,Game.Content),
                new Suicide(_suicideTexture, _world,34, 0,Game.Content),
                new Suicide(_suicideTexture, _world,35, 0,Game.Content),

                //wave3
                new Goblinb(_goblinbTexture, _world,40,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,41,0,Game.Content),
                new Suicide(_suicideTexture, _world,42, 0,Game.Content),
                new Suicide(_suicideTexture, _world,43, 0,Game.Content),
                new Suicide(_suicideTexture, _world,44, 0,Game.Content),
                new Suicide(_suicideTexture, _world,45, 0,Game.Content),
                new Suicide(_suicideTexture, _world,46, 0,Game.Content),
                new Balloon(_balloonTexture, _world,47, 4,Game.Content),

                //wave4
                new Bossgun(_bossgunTexture, _world,55,0,Game.Content),
                new Goblin(_goblinText, _world,56,0,Game.Content),
                new Goblin(_goblinText, _world,57,0,Game.Content),
                new Goblin(_goblinText, _world,58,0,Game.Content),
                new Goblin(_goblinText, _world,59,0,Game.Content),
                new Goblin(_goblinText, _world,60,0,Game.Content),
                new Goblin(_goblinText, _world,61,0,Game.Content),

                //wave5
                new Balloon(_balloonTexture, _world,69, 4,Game.Content),
                new Goblinb(_goblinbTexture, _world,68,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,69,0,Game.Content),
                new Goblinb(_goblinbTexture, _world,70,0,Game.Content),
                new Bossummon(_bosssumTexture, _world,71,0,Game.Content),
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            switch (stage)
            {
                ...
                case 4:
                    MediaPlayer.Stop();
                    _victory = new Victory10(_game, _player, _protag[0].life);
